function CountryFlags({ lng }) {
  console.log(lng);
  if (lng === "EL") {
    return <CountryFlagGRIcon />;
  } else {
    return <CountryFlagUKIcon />;
  }
}

function CountryFlagGRIcon() {
  return (
    <svg
...
export { CountryFlags, CountryFlagUKIcon, CountryFlagGRIcon };
